...
from transformer_bach.multihead_attention_custom import MultiheadAttentionCustom
...
class TransformerDecoderLayerCustom(Module):
    ...
    def __init__(self, d_model, nhead, attention_bias_type_self,attention_bias_type_cross,
        ...
        assert attention_bias_type_cross == 'diagonal'
        self.self_attn = MultiheadAttentionCustom(
            embed_dim=d_model,
            num_heads=nhead,
        ...
        self.diagonal_attn = nn.Linear(d_model, d_model)
    ...
    def forward(self, tgt, memory, tgt_mask=None, memory_mask=None,
        ...
        tgt2, a_cross = self.diagonal_attn(memory), None
